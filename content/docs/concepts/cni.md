...
- MKE 4k only supports integration with CNIs not detailed herein as custom CNI,
  such as Calico Enterprise, wherein the deployment and management of the
  component are managed directly by the customer.
