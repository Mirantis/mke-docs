...
- The latest `mkectl` binary, installed on your local environment (for installation instructions, see [Installing the mkectl CLI](../getting-started/install-mke-4k-cli)):
